...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Custom Tailoring Supplier for Boutiques | Atelier OS",
...
export default function CustomTailoringSupplierPage() {
  return <SeoServicePage
    ...
    intro="Atelier OS connects the in-store fitting appointment with fabric selection, customer records, garment configuration and international order preparation."
