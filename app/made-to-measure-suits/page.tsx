...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Made-to-Measure Suit Manufacturer & Supplier | verosuits",
...
export default function MadeToMeasureSuitsPage() {
  return <SeoServicePage
    ...
    summary="Made-to-measure ordering has many small decisions. verosuits organises them into a customer profile, fabric record, garment specification and PI summary, helping the shop verify what was selected before the order is confirmed."
