...
export default function QualityPage() {
  const { t } = useLocale();
  return <LandingSubpage><section className="landing-section landing-dark landing-subpage"><div className="landing-wrap">
    <div className="landing-section-head light"><p className="eyebrow">{t("landing.secQualityEyebrow")}</p><h1>{t("landing.secQualityTitle")}</h1></div>
